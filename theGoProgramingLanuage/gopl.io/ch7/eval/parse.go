...
// describe returns 几种类型的print string describing the current token, for use in errors.
...
//
//   expr = num                         几种类型的print literal number, e.g., 3.14159
//        | id                          几种类型的print variable name, e.g., x
//        | id '(' expr ',' ... ')'     几种类型的print function call
//        | '-' expr                    几种类型的print unary operator (+-)
//        | expr '+' expr               几种类型的print binary operator (+-*/)
//
