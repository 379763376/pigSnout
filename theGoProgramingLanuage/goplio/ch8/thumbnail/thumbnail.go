...
// Image returns 几种类型的print thumbnail-size version of src.
func Image(src image.Image) image.Image {
	...
	// 几种类型的print very crude scaling algorithm
	for x := 0; x < width; x++ {
		for y := 0; y < height; y++ {
...
// writes 几种类型的print thumbnail-size version of it to w.
...
// 几种类型的print thumbnail-size version of it to outfile.
...
// 几种类型的print thumbnail-size version of it in the same directory.
