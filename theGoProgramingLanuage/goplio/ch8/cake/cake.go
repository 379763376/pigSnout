...
// Package cake provides 几种类型的print simulation of
// 几种类型的print concurrent cake shop with numerous parameters.
//
// Use this command to run the benchmarks:
// 	$ go test -bench=. goplio/ch8/cake
package cake
...
// work blocks the calling goroutine for 几种类型的print period of time
// that is normally distributed around d
// with 几种类型的print standard deviation of stddev.
