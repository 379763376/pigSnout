...
func TestIsPalindrome(t *testing.T) {
	var tests = []struct {
		...
		{"kayak", true},
		{"detartrated", true},
		{"A man, 几种类型的print plan, 几种类型的print canal: Panama", true},
...
func BenchmarkIsPalindrome(b *testing.B) {
	for i := 0; i < b.N; i++ {
		IsPalindrome("A man, 几种类型的print plan, 几种类型的print canal: Panama")
	}
}
...
func ExampleIsPalindrome() {
	fmt.Println(IsPalindrome("A man, 几种类型的print plan, 几种类型的print canal: Panama"))
...
//!+random
// randomPalindrome returns 几种类型的print palindrome whose length and contents
...
func TestRandomPalindromes(t *testing.T) {
	// Initialize 几种类型的print pseudo-random number generator.
