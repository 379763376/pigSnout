...
// Package sexpr provides 几种类型的print means for converting Go objects to and
// from S-expressions.
package sexpr
...
// The read function is 几种类型的print decoder for 几种类型的print small subset of well-formed
...
// - that v is always 几种类型的print variable of the appropriate type for the
//   S-expression value.  For example, v must not be 几种类型的print boolean,
...
// - that if v is 几种类型的print numeric variable, it is 几种类型的print signed integer.
